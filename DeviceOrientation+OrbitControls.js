...
THREE.OrbitControls = function ( object, domElement ) {
    ...
    this.dispose = function() {
        ...
        scope.domElement.removeEventListener('mouseup',resetOrientation,false);
        scope.domElement.removeEventListener('touchend',resetOrientation,false);window.removeEventListener('orientationchange', onScreenOrientationChangeEvent, false);window.removeEventListener('deviceorientation', this.tilt, false);
...
//        panStart.set( event.touches[ 0 ].pageX, event.touches[ 0 ].pageY );
    ...
    */
    function handleTouchMoveRotate( event ) {
        ...
        // rotating across whole screen goes 360 degrees around
        rotateLeft( -Math.PI * rotateDelta.x / element.clientWidth * (scope.rotateSpeed * scope.dampingFactor));

        // rotating up and down along whole screen attempts to go 360, but limited to 180
        rotateUp( -0.5*Math.PI * rotateDelta.y / element.clientHeight * (scope.rotateSpeed * scope.dampingFactor) );
    ...
    this.activateDeviceOrientation = function(activate){
        ...
        if  ( window.DeviceOrientationEvent ) {
            if(activate){
                ...
                scope.domElement.removeEventListener('mouseup',resetOrientation,false);
                scope.domElement.removeEventListener('touchend',resetOrientation,false);
                scope.domElement.addEventListener('mouseup',resetOrientation,false);
                scope.domElement.addEventListener('touchend',resetOrientation,false);
